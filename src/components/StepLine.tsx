...
const styles = {
    ...
    ctaContainer: "relative w-full h-[350px] mt-10",
    ...
    ctaText: "text-white text-[1.35rem] md:text-xl max-w-2xl leading-relaxed",
    ...
    return ( 
        <section className={styles.container}>
            <div className="mx-8 mb-8 flex flex-col justify-between items-start">
                <h3 className="text-2xl mb-6 text-center font-bold" style={{fontFamily:  "playfair"}}>
