...
const styles={
    container: "w-full py-10 pt-14 flex flex-col justify-between items-center bg-white text-black",
    ...
    return ( 
        <section className={styles.container}>
            ...
            <div className="w-full flex flex-row justify-around items-center">
                ...
                <ol className="relative text-body border-s-8 border-pink-600">                  
                    <li className="mb-10 ms-7">            
                        ...
                        <p className="text-md">Cuentanos tu idea</p>
                    </li>
                    <li className="mb-10 ms-7">
                        <span className="absolute flex items-center justify-center w-7 h-7  bg-pink-600  text-pink-600 rounded-full -start-4 ring-4 ring-buffer">
            ...
            <div className="flex flex-col justify-between items-start">
                ...
                <p className="mx-10 mb-14 mt-10 text-xl">Trabajamos con una selección  <span className="text-pink-600 font-bold ">exclusiva</span> de haciendas, jardines, salones, playas y más sitios únicos, adaptados a todos los <span className="text-pink-600 font-bold ">estilos</span> y <span className="text-pink-600 font-bold ">presupuestos</span>.</p>
            </div>
